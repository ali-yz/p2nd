...
python scripts/cluster_simple_graph.py \
   --algo hdbscan \
...
PLOT_TITLE = f"Cluster Overlap - Algorithm: {algo_name_for_title} - Data: PC20_{DATA_VERSION}"
...
ylabels = [f"{k} " for k in ct_w.index]

plt.figure(figsize=(10, 6))
ax = sns.heatmap(ct_w, cmap="viridis", xticklabels=xlabels, yticklabels=ylabels, fmt="d")
